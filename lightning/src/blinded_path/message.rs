...
pub enum OffersContext {
	...
	StaticInvoiceRequested {
		...
		///
		/// Also useful for to rate limit the number of [`InvoiceRequest`]s we will respond to on
		/// recipient's behalf.
		///
...
pub enum AsyncPaymentsContext {
	...
	///
	/// [`ChannelManager::paths_to_static_invoice_server`]: crate::util::config::UserConfig::paths_to_static_invoice_server
