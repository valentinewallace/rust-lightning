...
pub(super) fn create_recv_pending_htlc_info(
	...
	let (
		...
		payment_metadata, payment_context, requires_blinded_error, invoice_request
	) = match hop_data {
		msgs::InboundOnionPayload::Receive {
			...
			(payment_data, keysend_preimage, custom_tlvs, sender_intended_htlc_amt_msat,
			 cltv_expiry_height, payment_metadata, None, false, None),
		msgs::InboundOnionPayload::BlindedReceive {
			...
			(Some(payment_data), keysend_preimage, custom_tlvs,
			 ...
			 intro_node_blinding_point.is_none(), invoice_request)
		}
