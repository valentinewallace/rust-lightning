...
impl Readable for InFlightHtlcs {
	fn read<Reader: io::Read>(reader: &mut Reader) -> Result<Self, msgs::DecodeError> {
...
pub struct ChannelManagerReadArgs<'a, Signer: 'a + Sign, M: Deref, T: Deref, K: Deref, F: Deref, R: Deref, L: Deref>
...
impl<'a, Signer: 'a + Sign, M: Deref, T: Deref, K: Deref, F: Deref, R: Deref, L: Deref>
		ChannelManagerReadArgs<'a, Signer, M, T, K, F, R, L>
	where M::Target: chain::Watch<Signer>,
		T::Target: BroadcasterInterface,
		K::Target: KeysInterface<Signer = Signer>,
		F::Target: FeeEstimator,
	...
	pub fn new(keys_manager: K, fee_estimator: F, chain_monitor: M, tx_broadcaster: T, router: Option<R>, logger: L, default_config: UserConfig,
...
impl<'a, M: Deref, T: Deref, K: Deref, F: Deref, R: Deref, L: Deref>
	ReadableArgs<ChannelManagerReadArgs<'a, <K::Target as KeysInterface>::Signer, M, T, K, F, R, L>> for (BlockHash, Arc<ChannelManager<M, T, K, F, R, L>>)
	where M::Target: chain::Watch<<K::Target as KeysInterface>::Signer>,
	      T::Target: BroadcasterInterface,
	      K::Target: KeysInterface,
	      F::Target: FeeEstimator,
	      ...
	      L::Target: Logger,
{
	fn read<Reader: io::Read>(reader: &mut Reader, args: ChannelManagerReadArgs<'a, <K::Target as KeysInterface>::Signer, M, T, K, F, R, L>) -> Result<Self, DecodeError> {
...
impl<'a, M: Deref, T: Deref, K: Deref, F: Deref, R: Deref, L: Deref>
	ReadableArgs<ChannelManagerReadArgs<'a, <K::Target as KeysInterface>::Signer, M, T, K, F, R, L>> for (BlockHash, ChannelManager<M, T, K, F, R, L>)
	where M::Target: chain::Watch<<K::Target as KeysInterface>::Signer>,
	      T::Target: BroadcasterInterface,
	      K::Target: KeysInterface,
	      F::Target: FeeEstimator,
	      ...
	      L::Target: Logger,
{
	fn read<Reader: io::Read>(reader: &mut Reader, mut args: ChannelManagerReadArgs<'a, <K::Target as KeysInterface>::Signer, M, T, K, F, R, L>) -> Result<Self, DecodeError> {
